...
abstract contract ERC1363 is ERC20, ERC165, IERC1363 {
    ...
    function transferAndCall(address to, uint256 amount, bytes memory data) public virtual returns (bool) {
        ...
        require(_checkOnTransferReceived(_msgSender(), to, amount, data), "ERC1363: transfer to non ERC1363Receiver implementer");
    ...
    function transferFromAndCall(
        ...
        require(_checkOnTransferReceived(from, to, amount, data), "ERC1363: transfer to non ERC1363Receiver implementer");
